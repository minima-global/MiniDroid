...
public class JSONValue {
	 ...
	 * 
	 * @see org.minima.utils.json.parser.JSONParser#parse(Reader)
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see org.minima.utils.json.parser.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	org.json.simple.JSONObject,
     ...
     * 
     * @see org.minima.utils.json.JSONObject#writeJSONString(Map, Writer)
     * @see org.minima.utils.json.JSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
	 ...
	 * 
	 * @see org.minima.utils.json.JSONObject#toJSONString(Map)
	 * @see org.minima.utils.json.JSONArray#toJSONString(List)
	 * 
	 * @param value
